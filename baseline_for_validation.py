...
# -*- coding: utf-8 -*-
"""
Created on Mon Jun 11 10:43:36 2018
...
testdata0=pd.read_csv("/hwj/bus/GPS/toBePredicted20171010.csv")
...
#    date=testdata0.O_DATA[index].split("-")[1]
    true=testdata0.pred_timeStamps[index]
    ...
    up=int(testdata0.O_UP[index].split(";")[0])
...
pred_timeStamps=pd.DataFrame(pred_time_list,columns=["sameday_median"])
predict_table=pd.concat([testdata1,pred_timeStamps],axis=1)
predict_table.to_csv("/hwj/bus/train_table_lll2.csv",index=0)
